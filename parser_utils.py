...
def make_diagrams():
    ...
    program_diagram.add_state('S0', 'Declaration-list#start_program', 'S1')
    # program_diagram.add_state('S10', 'Declaration-list', 'S1')
    program_diagram.add_state('S1', 'EPS#end_program', 'FINAL')
    ...
    declaration_list_diagram.add_state('S1', "Declaration-list#semantic_refresh", 'FINAL')
    ...
    fun_declaration_prime_diagram.add_state('S0', '(#dec_fun', 'S2')
    ...
    fun_declaration_prime_diagram.add_state('S5', 'EPS#end_func', 'FINAL')
    ...
    params_diagram.add_state('S0', 'int#push', 'S2')
    # params_diagram.add_state('S1', 'int', 'S2')
    params_diagram.add_state('S2', 'ID#push', 'S4')
    ...
    param_prime_diagram.add_state('S2', 'EPS#dec_parr', 'FINAL')
    # param_prime_diagram.add_state('S0', 'EPS', 'S3')
    param_prime_diagram.add_state('S0', 'EPS#dec_pvar', 'FINAL')
    transition_diagrams['Param-prime'] = param_prime_diagram

    # line 13
    compound_stmt_diagram = Transition_Diagram('Compound-stmt')
    compound_stmt_diagram.add_state('S0', '{#start_scope', 'S2')
    ...
    compound_stmt_diagram.add_state('S5', 'EPS#finish_scope', 'FINAL')
    ...
    statement_list_diagram.add_state('S1', 'Statement-list#semantic_refresh', 'FINAL')
    ...
    expression_stmt_diagram.add_state('S1', ';#pop3', 'FINAL')
    # expression_stmt_diagram.add_state('S2', ';', 'FINAL')
    expression_stmt_diagram.add_state('S0', 'break', 'S3')
    expression_stmt_diagram.add_state('S3', ';#scope_break', 'FINAL')
    ...
    selection_stmt_diagram.add_state('S4', 'Statement#save', 'S6')
    # selection_stmt_diagram.add_state('S5', 'Statement', 'S6')
    selection_stmt_diagram.add_state('S6', 'else#ifc_action', 'S8')
    # selection_stmt_diagram.add_state('S7', 'else', 'S8')
    selection_stmt_diagram.add_state('S8', 'Statement', 'S9')
    selection_stmt_diagram.add_state('S9', 'EPS#fill_jp', 'FINAL')
    # selection_stmt_diagram.add_state('S0', 'if', 'S1')
    # selection_stmt_diagram.add_state('S1', '(', 'S2')
    ...
    iteration_stmt_diagram.add_state('S0', 'repeat#loop', 'S1')
    ...
    iteration_stmt_diagram.add_state('S10', 'EPS#until', 'FINAL')
    ...
    return_stmt_diagram.add_state('S2', 'EPS#fun_return', 'FINAL')
    ...
    b_diagram.add_state('S5', 'H#parr', 'FINAL')
    ...
    h_diagram.add_state('S2', 'EPS#assign', 'FINAL')
    ...
    relop_diagram.add_state('S0', '<#push', 'FINAL')
    ...
    d_diagram.add_state('S1', 'Term', 'S3')
    d_diagram.add_state('S3', 'D#opera', 'FINAL')
    ...
    addop_diagram.add_state('S0', '+#push', 'FINAL')
    ...
    g_diagram.add_state('S0', '*#push', 'S1')
    # g_diagram.add_state('S1_0', '*', 'S1')
    g_diagram.add_state('S1', 'Factor', 'S3')
    g_diagram.add_state('S3', 'G#opera', 'FINAL')
    ...
    var_prime_diagram.add_state('S3', 'EPS#parr', 'FINAL')
    ...
    args_list_diagram.add_state('S1', 'Arg-list-prime#add_args', 'FINAL')
    ...
    arg_list_prime_diagram.add_state('S1', 'Expression', 'S3')#before
    arg_list_prime_diagram.add_state('S3', 'Arg-list-prime#add_args', 'FINAL')#before
    # arg_list_prime_diagram.add_state('S1', 'Expression', 'S2', '#add_args')#after
